...
import com.yuti.yutiaicodemother.model.dto.user.*;
import com.yuti.yutiaicodemother.model.vo.LoginUserVO;
...
public class UserController {
    ...
    public BaseResponse<Boolean> updateMyUser(@RequestBody UserUpdateRequest userUpdateRequest,
        ...
        // 7. 更新Session中的用户信息
        request.getSession().setAttribute(UserConstant.USER_LOGIN_STATE, userService.getLoginUser(request));
