package com.yuti.yutiaicodemother.langgraph4j;
...
import com.yuti.yutiaicodemother.langgraph4j.node.*;
...
public class CodeGenWorkflow {
    ...
    public Flux<String> executeWorkflowWithFlux(String originalPrompt) {
        return Flux.create(sink -> {
            ...
            }, "workflow-flux-" + System.currentTimeMillis());
            thread.start();
        });
    }
    ...
    public SseEmitter executeWorkflowWithSse(String originalPrompt) {
        ...
        }, "workflow-sse-" + System.currentTimeMillis());
        thread.start();
        return emitter;
    }
